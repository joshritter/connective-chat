  ...
  head: () => ({
    meta: [
      { title: "Hearth — team chat with channels, DMs and threads" },
      {
        name: "description",
        content:
          "Hearth is a fast, focused team chat app: organised channels, private direct messages and tidy threads that keep conversations on track.",
      },
      { property: "og:title", content: "Hearth — team chat with channels, DMs and threads" },
      {
        property: "og:description",
        content: "Organised channels, private direct messages and tidy threads for your team.",
      },
    ],
  }),
  component: Landing,
  ...
  return (
    <main className="min-h-dvh bg-sidebar text-sidebar-foreground">
      <div className="mx-auto flex max-w-3xl flex-col items-center px-6 py-24 text-center">
        <span className="font-display text-sm font-semibold uppercase tracking-[0.3em] opacity-70">
          Hearth
        </span>
        ...
        <p className="mt-4 max-w-xl text-base opacity-80">
          Channels for every project, direct messages for the quiet chats, and threads so the side
          conversations stay out of the way.
        </p>
        ...
        <ul className="mt-16 grid w-full gap-4 text-left sm:grid-cols-3">
          {[
            ...
            { icon: Users, title: "Direct messages", copy: "One-to-one and small group chats." },
            {
              icon: MessageSquare,
              title: "Threads",
              copy: "Replies stay tucked beside the message.",
            },
